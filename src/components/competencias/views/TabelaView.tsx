...
const ETAPA_COLOR: Record<EtapaCard, string> = {
  ...
  BAIXAR_NOTAS_ACESSO: "bg-sky-100 text-sky-700 dark:bg-sky-900/30 dark:text-sky-400",
  PEDIR_NOTAS_RECEITA_PR: "bg-teal-100 text-teal-700 dark:bg-teal-900/30 dark:text-teal-400",
  POSSIVEIS_SEM_MOVIMENTO: "bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-400",
